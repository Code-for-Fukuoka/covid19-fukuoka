  ...
  <div :class="$style.container">
    <div :class="[$style.heading, $style.multi]">
      <span
        ...
        :key="item.id"
        :class="[$style.item, $style.fzMedium]"
      >
    ...
    <ul :class="[$style.rectContainer, $style.double]">
      <li v-for="item in getSymptomList" :key="item.id" :class="$style.symptom">
    ...
    <div v-if="othersConditon.display === true">
      <p
        v-if="othersConditon.custom.display === false"
        ...
        <i18n path="{duration}続いている">
          <template v-slot:duration>
            ...
            >
              <template v-slot:day>
                <strong
                  ><span :class="$style.fzNumeric">{{
                    othersConditon.day
                  }}</span
                  >日{{ othersConditon.inequality }}</strong
                >
              </template>
            </i18n>
          </template>
